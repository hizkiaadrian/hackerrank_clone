...
import {TestCase, TestCaseResult} from '../interfaces/TestCasesParameters.interface';
...
interface TestCasesParameters {
    testCases: TestCase[];
    testCaseResults: TestCaseResult[];
}

function TestCasesPanel({testCases, testCaseResults} : TestCasesParameters) {
return (
